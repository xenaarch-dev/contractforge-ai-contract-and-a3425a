...
export const metadata: Metadata = {
  title: "Refund Policy ? ContractForge",
  description: "ContractForge refund and cancellation policy. Requests accepted within 7 days of initial subscription purchase.",
};

export default function RefundPage() {
  const html = mdToHtml(readLegalDoc("refund"));
  return <LegalPage html={html} title="Refund Policy" />;
}
